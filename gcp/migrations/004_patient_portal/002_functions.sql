-- ============================================================
-- GCP Cloud SQL Migration - 003_functions_patient_portal.sql
-- Execution Order: 010
...
AS $$
  ...
  WHERE t.tenant_id = p_tenant_id
    ...
    AND p_tenant_id IN (SELECT tenant_id FROM public.profiles WHERE id = current_setting('app.current_user_id')::uuid)
