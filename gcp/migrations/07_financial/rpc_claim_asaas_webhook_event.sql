CREATE OR REPLACE FUNCTION public.claim_asaas_webhook_event(p_event_key text, p_event_type text, p_payload jsonb)
 RETURNS TABLE(status text, attempts integer, already_processed boolean, claimed boolean)
 LANGUAGE plpgsql
 SECURITY DEFINER
