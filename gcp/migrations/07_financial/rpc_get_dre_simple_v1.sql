CREATE OR REPLACE FUNCTION public.get_dre_simple_v1(p_start_date date, p_end_date date)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
...
begin
  ...
  if not v_is_admin then
    ...
    perform public.raise_app_error('FORBIDDEN', 'Apenas administradores podem ver relat├│rios');
