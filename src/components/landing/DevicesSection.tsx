...
const devices = [
  ...
  },
  {
    icon: Tablet,
    name: "Tablet",
    description: "Perfeito para o balcão da clínica"
  },
  {
    icon: Smartphone,
    name: "Celular",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-teal-100 border border-teal-200 mb-6">
            ...
            <span className="text-sm font-medium text-teal-600">Compatibilidade</span>
          </div>
                ...
                >
                  <div className="flex flex-col items-center p-8 rounded-3xl bg-white border-2 border-teal-100 shadow-lg hover:shadow-2xl hover:border-teal-300 transition-all duration-300 hover:-translate-y-2 h-full">
                    ...
                    <div className="relative mb-6 flex-shrink-0">
                      {/* Outer glow */}
                      <div className="absolute inset-0 bg-gradient-to-br from-teal-400 to-cyan-400 rounded-2xl blur-xl opacity-20 group-hover:opacity-40 transition-opacity" />

                      {/* Device icon container */}
                      <div className="relative h-32 w-32 rounded-2xl bg-gradient-to-br from-teal-100 to-cyan-100 flex items-center justify-center">
                        <Icon className="h-16 w-16 text-teal-600 group-hover:scale-110 transition-transform duration-300" aria-hidden="true" />
