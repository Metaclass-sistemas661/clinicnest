/**
 * Wrapper tipado para RPCs que não estão no types gerado.
 * Cada função mapeia 1:1 para uma RPC SECURITY DEFINER no banco.
...
const rpc = api.rpc.bind(api) as RpcFn;
