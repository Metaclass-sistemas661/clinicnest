    ...
    <MainLayout>
      ...
      <TooltipProvider>
        <div className="space-y-6">
          ...
          <div className="relative overflow-x-clip -mx-4 -mt-4 md:-mx-8 md:-mt-6 bg-teal-600 dark:bg-teal-700 px-4 pt-8 pb-12 md:px-8 md:pt-6 md:pb-14 lg:px-10 lg:pt-5 lg:pb-16 text-white">
