          ...
          <TabsList
            className={
              simpleModeEnabled
                ...
                : "grid w-full grid-flow-col auto-cols-[minmax(140px,1fr)] overflow-x-auto h-auto gap-3 p-2"
            }
          >
            ...
            {!simpleModeEnabled ? (
              <TabsTrigger value="cashflow" className="gap-1 md:gap-2 text-xs md:text-sm py-2 px-6 w-full justify-center" data-tour="finance-tab-cashflow">
            ...
            {!simpleModeEnabled ? (
              <TabsTrigger value="commissions" className="gap-1 md:gap-2 text-xs md:text-sm py-2 px-6 w-full justify-center" data-tour="finance-tab-commissions">
            ...
            {!simpleModeEnabled ? (
              <TabsTrigger value="salaries" className="gap-1 md:gap-2 text-xs md:text-sm py-2 px-6 w-full justify-center" data-tour="finance-tab-salaries">
            ...
            {!simpleModeEnabled ? (
              <TabsTrigger value="bills_payable" className="gap-1 md:gap-2 text-xs md:text-sm py-2 px-6 w-full justify-center">
            ...
            {!simpleModeEnabled ? (
              <TabsTrigger value="bills_receivable" className="gap-1 md:gap-2 text-xs md:text-sm py-2 px-6 w-full justify-center">
