          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>E-mail somente leitura · Telefone editável</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                O e-mail não pode ser alterado aqui. Entre em contato com o administrador.
              </p>
            </div>
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>Ative ou desative notificações por tipo</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent>
