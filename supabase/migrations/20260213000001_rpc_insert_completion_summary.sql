-- RPC insere em appointment_completion_summaries para notificar admin em tempo real
...
BEGIN
  ...
  -- Inserir summary para admin receber via Realtime (qualquer conclusão: admin ou profissional)
