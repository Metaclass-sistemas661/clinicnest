...
BEGIN
  ...
  IF NOT public.tenant_has_feature(p_tenant_id, 'advanced_reports') THEN
    RAISE EXCEPTION 'Relatórios avançados disponíveis apenas nos planos Pro e Premium. Faça upgrade em Assinatura para liberar.';
  END IF;
