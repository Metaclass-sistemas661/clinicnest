-- Phase 3: Concurrency hardening for appointment completion

-- 1) Prevent duplicate product-sale financial transactions per appointment+product
...
-- 2) Make complete_appointment_with_sale safe under concurrent calls
