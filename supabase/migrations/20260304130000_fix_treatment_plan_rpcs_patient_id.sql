-- ============================================================
-- FIX: Corrigir RPCs de treatment_plans após rename client_id → patient_id
-- A migração 20260330300000 renomeou client_id → patient_id na tabela,
-- mas estas RPCs não foram atualizadas.
-- ============================================================
