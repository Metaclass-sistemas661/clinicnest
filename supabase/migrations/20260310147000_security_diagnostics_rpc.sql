-- P11: Admin security diagnostics RPC (read-only)
...
REVOKE ALL ON FUNCTION public.get_security_diagnostics_v1() FROM public;
GRANT EXECUTE ON FUNCTION public.get_security_diagnostics_v1() TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_security_diagnostics_v1() TO service_role;
