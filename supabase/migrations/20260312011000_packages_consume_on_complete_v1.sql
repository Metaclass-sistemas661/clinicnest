-- Milestone 5: consumir sessão de pacote automaticamente ao concluir atendimento
...
BEGIN
  ...
  -- Buscar agendamento primeiro e usar tenant do próprio agendamento (fonte de verdade)
  SELECT
    a.*,
