-- Fix: log_clinical_access referenciava appointments.client_id que foi renomeado para patient_id
...
BEGIN
  ...
  -- Flag acesso incomum — paciente sem agendamento recente deste profissional
    ...
    IF NOT EXISTS (
      SELECT 1
       ...
       WHERE a.tenant_id = v_tenant_id
         ...
         AND a.patient_id = p_patient_id::uuid
