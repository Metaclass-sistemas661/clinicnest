-- Fix: get_client_timeline_v1 referencing non-existent columns
-- appointments uses patient_id (not client_id) and procedure_id (not service_id)
-- orders uses patient_id (not client_id)
