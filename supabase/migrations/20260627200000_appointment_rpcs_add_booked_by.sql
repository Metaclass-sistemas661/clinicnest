-- Add p_booked_by_id parameter to create_appointment_v2 and update_appointment_v2
-- so the referrer/booker is saved atomically during creation/update.
-- Column booked_by_id already exists on appointments (added in 20260327300000).

-- ════════════════════════════════════════════════════════════════
-- 1. create_appointment_v2  (add p_booked_by_id uuid DEFAULT NULL)
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- 2. update_appointment_v2  (add p_booked_by_id uuid DEFAULT NULL)
-- ════════════════════════════════════════════════════════════════
