-- ============================================================================
-- Migration: RPCs para perfil do paciente no Portal do Paciente
-- Cria get_patient_profile e update_patient_contact como SECURITY DEFINER
-- para que o portal do paciente consiga ler e atualizar os dados sem depender
-- de RLS direta na tabela patients.
-- ============================================================================

-- ─── 1) RPC: get_patient_profile ──────────────────────────────────────────
-- Retorna os dados pessoais do paciente autenticado (via patient_profiles).
...
-- Permite que o paciente atualize telefone, email e endereço.
-- Campos clínicos (cpf, date_of_birth, allergies) NÃO podem ser alterados.
...
-- ─── 3) Grant execute para authenticated ──────────────────────────────────
