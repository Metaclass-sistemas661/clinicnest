...
-- + Fix "Notificar" button to actually send WhatsApp/email
-- ============================================================

-- 1. Function that finds compatible waitlist entries when an appointment is cancelled
--    and creates notifications + marks them as notificado
...
-- 2. Create the waitlist_notifications queue table
...
-- Index for the automation worker to pick up pending notifications
